...
class SpaProgrammerModalBody {
    ...
    date = new Date();
    temperature = 40;
    setHeaterProgrammationBody;
}
exports.SpaProgrammerModalBody = SpaProgrammerModalBody;
function SpaProgrammerModal({ show, handleClose, addHeater }) {
